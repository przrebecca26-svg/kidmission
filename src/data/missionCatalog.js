...
export const REWARD_CATALOG = [
  { id: "r1", fr: "Choisir le dessert", he: "לבחור את הקינוח", val: 200 },
  { id: "r2", fr: "Petit jouet", he: "צעצוע קטן", val: 300 },
  { id: "r3", fr: "Sortie avec maman", he: "יציאה עם אמא", val: 500 },
  { id: "r4", fr: "Activité spéciale", he: "פעילות מיוחדת", val: 700 },
  { id: "r5", fr: "Gros cadeau", he: "מתנה גדולה", val: 1000 },
];

export const HOUSE_RULES = [
  { fr: "Les bonus et malus sont comptés chaque jour.", he: "הבונוסים והקנסות נספרים בכל יום." },
  { fr: "Les Jokers ne peuvent pas être achetés avec des shekels.", he: "אי אפשר לקנות ג'וקרים בכסף." },
  { fr: "Les Jokers se gagnent grâce aux efforts, au bon comportement et aux défis réussis.", he: "ג'וקרים מרוויחים בזכות מאמץ, התנהגות טובה ועמידה באתגרים." },
  { fr: "Les Jokers ne peuvent pas annuler un gros malus (mensonge, mot de la maîtresse, méchanceté, etc.).", he: "ג'וקרים אינם יכולים לבטל קנס חמור (שקר, הערה מהמורה, התנהגות רעה וכו')." },
  { fr: "Le compteur d'argent ne descend jamais en dessous de 0 ₪.", he: "סכום הכסף לעולם לא יורד מתחת ל-0 ₪." },
  { fr: "Être honnête, gentille, respectueuse, courageuse et faire de son mieux vaut plus que n'importe quel bonus ou récompense.", he: "להיות כנה, אדיבה, מכבדת, אמיצה ולעשות תמיד את המיטב חשוב יותר מכל בונוס או פרס." },
];
...
export const BUILTIN_CATALOG = {
  bonus: BONUS_CATALOG,
  malus: MALUS_CATALOG,
  weekly: WEEKLY_CATALOG,
  jokerEarn: JOKER_EARN_CATALOG,
  jokerUse: JOKER_USE_CATALOG,
